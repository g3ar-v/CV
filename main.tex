...
\cvtext{\textbf{ML tools}: JupyterNotebook, hugginface}
...
\fcolorbox{white}{darkcol}{\begin{minipage}[c][2.5cm][c]{1\mpwidth}
	\begin {center}
		...
		\large{ \textcolor{white} {Software Engineer/ Machine Learning Engineer} }
	\end {center}
\end{minipage}} \\[14pt]
\vspace{-12pt}
%---------------------------------------------------------------------------------------
...
\cvevent
	...
	{\textbf{Some modules studied}: Data Structures and Algorithm, Machine Learning, Networking, Natural Language processing, Artificial Intelligence, Functional Programming, Computer Vision, Security of Real-World Systems}
...
\cvevent
	...
	{AI assistant that controls smart devices, manages productivity and provides information}
\vfill\null
...
\begin{itemize}
  \item Uses a combination of RFID and fingerprint recognition to identify students
  \item Gives the admin access to track attendance over the internet
...
\vfill\null
 ...
 \begin{itemize}
	\item A mulitplayer game with a similar style to donkey kong and super mario combined.
